<header>
        <div class="wrap">
            <h1><a href="/">logo</a></h1>
            <ul class="gnb">
                <li><a href="/akkomis.php">AKKOMI'S</a></li>
                <li>
                    <a href="/pew.php">CHARACTER</a>
                    <ul>
                        <li><a href="/pew.php">PEW</a></li>
                        <li><a href="/chacha.php">CHACHA</a></li>
                        <li><a href="/hari.php">HARI</a></li>
                        <li><a href="/shasha.php">SHASHA</a></li>
                    </ul>
                </li>
                <li>
                    <ul>

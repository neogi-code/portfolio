...
<body>
    ...
    <section class="program">
        <div class="gridBox">
            ...
            <div class="gridItem"><a href="Q&A/index.html"></a></div>
    ...
    <section class="end">
        ...
        <div class="linked">
            <div class="wrap">
                <a href="식단표/index.html"><span>VandS <span class="color">식단 안내</span></span></a>
                <a href="시술 후 주의사항/index.html"><span>VandS <span class="color">프로그램<br>시술 후, 주의사항</span></span></a>
            </div>
        </div>
    </section>
</main>
